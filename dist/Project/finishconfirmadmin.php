<?php
include('Shopify_RegisterPage/sessiondeleteconfirm.php');
$_SESSION['confirm_admin']=NULL;
...
<body>
    ...
    <div class="w3-teal w3-hover-light-blue  profile1">
        <b class="w3-text-red">Konfirmasi Pembayaran dengan No Faktur : <?php echo $login_session;?> telah berhasil!!!</b>
    </div>
                    ...
                    <div id="<?php echo $pesanid[$i];?>" class="w3-modal" >
                        <div class="w3-modal-content w3-card-8 w3-animate-zoom w3-round-large" style="max-width:500px">
                            ...
                            <div class="w3-section" >              
                                ...
                                <label class="w3-padding-medium" style="height:51px" for="nofak">Total Bayar :</label>
