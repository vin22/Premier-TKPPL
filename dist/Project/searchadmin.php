...
<body>
    ...
    <div class="w3-content w3-container w3-padding-64">
        <div class="row">
            ...
            for($a=0;$a<$bykrow;$a++)
            {
                $cariquery = mysql_query("SELECT * FROM produk WHERE produkID='$searchrow[$a]'",$connection);
                $rowtotal = mysql_fetch_assoc($cariquery);
                            ...
                            <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
                                ...
                                <form class="w3-container w3-border-top" action="Shopify_RegisterPage/proseseditproduct.php" method="post" enctype="multipart/form-data">
                                    <div class="w3-section">
                                        ...
                                        <img src="<?php echo $rowtotal['kategori'];?>/<?php echo $rowtotal['Foto'];?>" id="uploadPreview" style="width: 100px; height: 100px; float:right;" >
