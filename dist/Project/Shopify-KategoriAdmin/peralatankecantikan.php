            ...
            <div class="col-sm-2 col-md-3">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <button onclick="document.getElementById('<?php echo $row['produkID'];?>1').style.display='block'" class="w3-hover-white w3-hide-small w3-right login" style="width:90px;">Edit</button>
                        <div id="<?php echo $row['produkID'];?>1" class="w3-modal">
                            <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
                                <div class="w3-center">
                                    <span onclick="document.getElementById('<?php echo $row['produkID'];?>1').style.display='none'" class="w3-closebtn w3-hover-red w3-container w3-padding-16 w3-padding-medium w3-display-topright" title="Tutup">&times;</span>
                                ...
                                <form class="w3-container w3-border-top" action="../Shopify_RegisterPage/proseseditproduct.php" method="post" enctype="multipart/form-data">
                                    <div class="w3-section">
                                        <input type="hidden" name="idedit" value="<?php echo $row['produkID'];?>">
                                        <img src="../<?php echo $kat;?>/<?php echo $row['Foto'];?>" id="uploadPreview" style="width: 100px; height: 100px; float:right;" >

                                        <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="Nama Produk" name="nama" value="<?php echo $row['namaproduk'];?>" style="width:300px;" required>


                                        <input class="w3-input w3-border w3-margin-bottom" type="text" style="width:300px;" placeholder="Harga Produk"  value="<?php echo $row['harga']?>" name="harga" required>
                                        <label style="float:right;" for="uploadImage"><?php echo $row['Foto'];?></label>
                                        <input id="uploadImage" type="file" name="image" value="<?php echo $row['Foto'];?>"  class="w3-padding-medium"  style="clear:both; float:right; width:117px;" onchange="PreviewImage();">
                                        
                                        <input class="w3-input w3-border w3-margin-bottom" type="text" style="width:300px;" value="<?php echo $row['stok'];?>"  placeholder="Stok Produk(<?php echo $row['stok'];?>)" name="stok" required>

                                        <textarea class="w3-input w3-border w3-margin-bottom" placeholder="Deskripsi(<?php echo $row['deskripsi'];?>)" name="deskripsi"  style="height:106px;" required><?php echo $row['deskripsi'];?></textarea>
                                        <textarea class="w3-input w3-border w3-margin-bottom" placeholder="Spesifikasi(<?php echo $row['spesifikasi'];?>)" name="spesifikasi"  style="height:106px;" required><?php echo $row['spesifikasi'];?></textarea>
                                        <input type="submit" name="edit" class="w3-btn w3-section blue login-1 w3-margin-right" style="width:270px;" value="Edit Product">
                                        <a href="#" onclick="document.getElementById('<?php echo $row['produkID'];?>1').style.display='none'" class="w3-btn cancel" style="width:270px;" >Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>         
                        <button  style="width:90px;" onclick="document.getElementById('<?php echo $row['produkID'];?>').style.display='block'" class="w3-hover-white w3-hide-small w3-right login" >Hapus</button>
                        <div id="<?php echo $row['produkID'];?>" class="w3-modal">
                            <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px">
                                <div class="w3-center">
                                    <span onclick="document.getElementById('<?php echo $row['produkID'];?>').style.display='none'" class="w3-closebtn w3-hover-red w3-container w3-padding-16 w3-display-topright atas" title="Tutup">&times;</span>
                                    <div class="w3-container w3-blue ">
                                ...
                                <form class="w3-container w3-border-top" action="../Shopify_RegisterPage/prosesdeleteproduct.php" method="post">
                                    <div class="w3-section">
                                        ...
                                        <a href="" onclick="document.getElementById('<?php echo $row['produkID'];?>').style.display='none'" class="w3-btn cancel" style="width:270px;" >Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
