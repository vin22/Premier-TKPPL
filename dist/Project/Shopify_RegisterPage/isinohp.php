<?php
include('verifikasinohp.php');
if(isset($_SESSION['forget_nohp_user'])){
        ...
        <div class="card">
            ...
            ?>
                ...
                <form action="" method="post">
                    ...
                    <input type="text" name="nama" id="nama" value="<?php echo $kolom_db['nama'];?>" placeholder="Fullname" disabled>
                    </div>
                    <div class="email">
                        <label for="number">No HP</label>
                        <input type="text" name="number" id="number"  maxlength="12"   autocomplete="off" placeholder="No HP" required>
                    ...
                    <select name="tahun" required>
                        ...
                        <input type="submit" name="ok" value="Submit Detail">
                    </div>
