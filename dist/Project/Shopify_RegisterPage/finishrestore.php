<?php
include('sessionforgetuser.php');
$_SESSION['forget_user']=NULL;
$_SESSION['forget_nohp_user']=NULL;
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    ...
    <main>
        <div class="card">
            <h5>Anda berhasil mengubah password Anda?</h5>
            
            <div class="email">
                <form  action="masuk.php">
                    <p class="font">Selamat <b><?php echo $login_session;?></b> Anda telah berhasil mengubah password Anda</p>
