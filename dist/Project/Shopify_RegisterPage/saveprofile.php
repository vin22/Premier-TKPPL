<?php
include('prosesedit.php'); // Memasuk-kan skrip Login 
if(isset($_SESSION['edit_user'])){
    header("location:../finisheditprofile.php");
}
...
<head>
    <meta charset="utf-8">
    <title>Editing Profile &#124; Shopify</title>
    <style>
        .logo1 {
            float: left;
            margin-left: 7px;
...
<body>
    <header>
        <div class="head">
            ...
            <div class="head-2">
                <h5>EDITING PROFILE IN SHOPIFY</h5>
        ...
        <div class="right-side">
            <div class="right-side2">
                <form action="" method="post">
                    <input type="text" name="fullname" id="fullname" value="<?php  echo $kolom_db['nama'];?>" autocomplete="off" placeholder="Fullname"  required>
                    <input type="text" name="number" id="number" value="<?php  echo $kolom_db['nohp'];?>" maxlength="12" autocomplete="off" placeholder="Mobile Phone Number" required>
                    <input type="text" name="address" id="address" value="<?php  echo $kolom_db['alamat'];?>" autocomplete="off" placeholder="Address" required>
                    <div class="gender">
                        <!-- Radio -->
                        <input type="radio" name="jk" id="radio1" value="L" <?php if($kolom_db['jeniskelamin']=="L"){ echo "checked=\"checked\"";};?> required />
                        <label for="radio1" class="inline p1">Male</label>
                        <input type="radio" name="jk" id="radio2" value="P" <?php if($kolom_db['jeniskelamin']=="P"){ echo "checked=\"checked\"";};?> required />
                    ...
                    <input type="submit" class="w3-btn blue w3-hover-pale-blue" name="save" id="save" value="Save Profile">
                </form>
            </div>
        </div>
    </main>
