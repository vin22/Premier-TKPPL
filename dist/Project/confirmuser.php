<?php
include('Shopify_RegisterPage/prosesconfirm.php');
...
$bykkode= mysql_query("select * from pesan where binary email='$email' AND NOT statusbayar=''", $connection);
...
<body>
    ...
    <section id="cart_items">
        <div class="container bgimg-1 ">
            ...
            <div class="container">
                <a href="Shopify-HomePage.php" class="w3-round-medium w3-margin-bottom w3-btn w3-red w3-left w3-hover-pale-red">Home</a>
                <?php
                $query2=mysql_query("select * from pesan where NOT statusbayar='Berhasil' AND NOT statusbayar='' AND email='$email'");
                $num2=mysql_num_rows($query2);
                if($num2==0)
                {?>
                <input type="submit" class="w3-round-medium w3-btn w3-red w3-right w3-hover-pale-red" name="info" value="Info Rek Admin" formaction="inforekadmin.php" disabled>
                <?php
                }
                else if($num2>0)
                {?>
                <a href="inforekadmin.php" class="w3-round-medium w3-btn w3-red w3-right w3-hover-pale-red">Info Rek Admin</a>
                <?php
