<?php
include('Shopify_RegisterPage/sessionaddbon.php');
...
<head>
    ...
    <title>Generate Bon | Shopify</title>
...
<body>
        ...
        <nav>
            <div class="w3-top">
                <ul class="w3-navbar w3-left-align w3-large">
                    ...
                    <li><a href="Shopify-HomePage.php" class="homecolor"><i class="fa fa-tags w3-margin-right"></i>Bon</a></li>
    ...
    <section id="cart_items">
        <div class="container bgimg-1">
            <div class="head">
                <h4 class="w3-left w3-margin w3-btn w3-white w3-hover-red">No Faktur : <?php echo $login_session;?></h4>
                <h4 class="w3-right w3-margin w3-btn w3-white w3-hover-red">Tanggal Order : <?php 
                    echo $date;?></h4>
            </div>
            <div class="table-responsive cart_info">
                <table class="table table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <?php
                                ...
                                $total[$i]=$hargarow[$i]*$quantityrow[$i];
                                $jumlah+=$total[$i];
                            ?>
                            ...
                            <td class="cart_total">
                                <p class="w3-btn w3-blue cart_total_price" style="width:200px"><?php echo "Rp.".number_format($total[$i],0,",",".");?></p>
                            </td>
                    ...
                    <tfoot> 
                        <tr class="cart_menu">
                            <td colspan="4"><h4 class="w3-right">Total:</h4></td>
                            <td class="w3-center" style="width:200px;"><?php echo "Rp.".number_format($jumlah,0,",",".");?></td>
            ...
            <form action="inforekadmin.php" class="w3-margin-bottom" method="post">
                <a href="Shopify-HomePage.php" class="w3-round-medium w3-hover-pale-red w3-btn w3-red">Home</a>
                <input type="submit" class="w3-round-medium w3-hover-pale-red w3-right w3-btn w3-red" style="height:34px" name="next" value="Info Rek Admin">      
            </form>
        </div>
